...
const Card = ({ carts , setCarts}) => {
    ...
    return (
        <div className='p-10 max-w-7xl mx-auto'>
            ...
            <button onClick={handlePayment} className='btn w-full mt-5 bg-gradient-to-r from-[#4F39F6] to-[#9514FA] text-white text-2xl rounded-full'>Proceed to Checkout</button>
                </>
            }
